            ...
            <div class="card">
                <div class="card-body">
                    <div class="nama">
                        ...
                        <input class="form-control form-control-sm mb-3" type="text" name="kode_vaksin" aria-label="default input example">
                    </div>
                    <div class="no_hp">
                        <label>Nama Vaksin</label>
                        <input class="form-control form-control-sm mb-3" type="text" name="nama_vaksin" aria-label="default input example">
                    </div>
                </div>
            </div>        
        </div>
